...
sed -i -E 's/(PKG_VERSION:=)[^ ]+/\1 1.14.0-alpha.2/' feeds/packages/net/sing-box/Makefile
sed -i -E 's|(PKG_HASH:=)[^ ]+|\1 2e60cf99c02a3d026cdc9b8eefd24c5ed22c3c7ff6bb3d907f7d0172aa302947|' feeds/packages/net/sing-box/Makefile
